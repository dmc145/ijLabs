...
- (void)removeItem:(BNRItem *)p
{
    ...
    // When a user deletes a BNRItem, you must inform the context so that it is removed from the database.
...
- (BOOL)saveChanges
{
    /* Chap. 16 Before, BNRItemStore would write out the entire NSMutableArray of BNRItems when you asked it to save using keyed archiving.
